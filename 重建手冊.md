...
```bash
cd ~
git clone https://github.com/joyphoneoff-design/Crawl_R2R.git
cd Crawl_R2R
```
...
### 完整 Pipeline 流程
```
Crawl_R2R → MD_PipeLine → rag_data_washer → R2R
  (8502)      (8501)          (CLI)        (8001)
```
...
```bash
# MD_PipeLine
cd ~/MD_PipeLine && streamlit run pipeline_webui.py --server.port 8501
